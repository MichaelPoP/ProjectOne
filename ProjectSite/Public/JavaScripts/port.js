...
// }
// function changePanelBack (event) {
...
//  boxes[i].addEventListener("mouseover", changePanelBorder);
//  boxes[i].addEventListener("mouseout", changePanelBack);
//    }
...
//     (event.target.style.outline = "4px outset #5e79ad").fadeIn(500);
// //use 'event.target' in order to loop through a lot of events that you don't want to individually name
// }
// function changePanelBack (event) {
